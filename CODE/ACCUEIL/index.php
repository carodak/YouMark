...
?>
<!-- bannière -->
<script src="includes/countUp/countUp.js"></script>
<section class="container-fluid banner">
		...
		<div class="inner-banner">
				...
				<h2>  <div class="jumbo" id="myTargetElement" value="Utilisateurs nous font confiance">   </h2>
 ...
 <div class="container-fluid">
	 <div class="row content">
  	<div class="col-md-8 col-sm-12">
		<ul id="main-nav">
			<li class="current"><a href="index.php">Nouveautés</a></li>
                                ...
                                <!-- Dropdown -->
                                   ...
                                   <button class="btn btn-success dropdown-toggle" type="button" data-toggle="dropdown">Date d'ajout
                                    ...
                                    <ul class="dropdown-menu">
									  <li><a href="index.php?date_ajout=0">Tous</a></li>
                                      <li><a href="index.php?date_ajout=1">Aujourd'hui</a></li>
                                      <li><a href="index.php?date_ajout=7">Cette semaine</a></li>
                                      <li><a href="index.php?date_ajout=30">Ce mois-ci</a></li>
                                      <li><a href="index.php?date_ajout=365">Cette année</a></li>
                                    </ul>
                                  </div>
                                  <!-- Fin Dropdown -->
                                            ...
                                            $debut = ($page-1) * $limit;
											$cmpt = $debut+1;
                                            $marque_page = $managerMarque_Page->trie_par_date_pagination($debut,$limit,$date_ajout);
											?>
											...
											<?php
													$marque_pages_nouveaute_en_entier = $managerMarque_Page->trie_par_date($date_ajout);
													$total = count($marque_pages_nouveaute_en_entier);
													...
													if($difference <= 5)
				    							{
													...
													if($total_pages <= 5){
														...
														for($i=1; $i<=$total_pages; $i++){
															...
															echo "<li class=\"$c\"><a href='index.php?page=".$i."'>".$i."</a></li>";
														}
														echo "</ul></nav>";
														...
														if($page > 1){
															echo "<li><a href='index.php?page=1'>Première</a></li>";
														...
														{
															echo "<li><a href='index.php?page=".($page + 1)."'>>></a></li>";
															echo "<li><a href='index.php?page=".$total_pages."'>Suivant</a></li>";
														}
														echo "</ul></nav>";
													}
...
var numAnim = new CountUp("myTargetElement", 0, <?php echo $val; ?>);
numAnim.start(function() {document.getElementById("myTargetElement").innerHTML += " Inscrits !";
}  );
